...
def title_draw():
    app.draw_text("EasyGL Scene Demo", WIDTH / 2 - 250, HEIGHT / 2 - 100, font="arial", size=48, color=(255, 255, 255), z=10)
    app.draw_text("Press ENTER to Start", WIDTH / 2 - 150, HEIGHT / 2 + 20, font="arial", size=24, color=(200, 200, 200), z=10)
...
def game_setup():
    global player_pos, objects, test_texture, last_fps_update_time
